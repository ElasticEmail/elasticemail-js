...
Downloadable library clients can be found in our Github repository <a target='_blank' href='https://github.com/ElasticEmail/elasticemail-js'>here</a>
...
api.campaignsAutomationByNameTriggerPost(name, contactEmail, callback);
