...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.DomainData();
  });
  ...
  describe('DomainData', function() {
    it('should create an instance of DomainData', function() {
      // uncomment below and update the code to test DomainData
      //var instance = new ElasticEmail.DomainData();
      //expect(instance).to.be.a(ElasticEmail.DomainData);
    });

    it('should have the property validationLog (base name: "ValidationLog")', function() {
      // uncomment below and update the code to test the property validationLog
      //var instance = new ElasticEmail.DomainData();
