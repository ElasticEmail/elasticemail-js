...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.EmailView();
  });
  ...
  describe('EmailView', function() {
    it('should create an instance of EmailView', function() {
      ...
      //var instane = new ElasticEmail.EmailView();
      //expect(instance).to.be.a(ElasticEmail.EmailView);
    });

    it('should have the property body (base name: "Body")', function() {
      // uncomment below and update the code to test the property body
      //var instance = new ElasticEmail.EmailView();
