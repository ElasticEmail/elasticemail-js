...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.ContactHistory();
  });
  ...
  describe('ContactHistory', function() {
    it('should create an instance of ContactHistory', function() {
      ...
      //var instane = new ElasticEmail.ContactHistory();
      //expect(instance).to.be.a(ElasticEmail.ContactHistory);
    });
    ...
    it('should have the property eventType (base name: "EventType")', function() {
      ...
      //var instance = new ElasticEmail.ContactHistory();
