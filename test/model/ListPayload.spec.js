...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.ListPayload();
  });
  ...
  describe('ListPayload', function() {
    it('should create an instance of ListPayload', function() {
      // uncomment below and update the code to test ListPayload
      //var instane = new ElasticEmail.ListPayload();
      //expect(instance).to.be.a(ElasticEmail.ListPayload);
    });
    ...
    it('should have the property listName (base name: "ListName")', function() {
      ...
      //var instance = new ElasticEmail.ListPayload();
