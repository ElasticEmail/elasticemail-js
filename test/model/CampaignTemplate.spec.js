...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.CampaignTemplate();
  });
  ...
  describe('CampaignTemplate', function() {
    it('should create an instance of CampaignTemplate', function() {
      ...
      //var instane = new ElasticEmail.CampaignTemplate();
      //expect(instance).to.be.a(ElasticEmail.CampaignTemplate);
    });
    ...
    it('should have the property poolname (base name: "Poolname")', function() {
      ...
      //var instance = new ElasticEmail.CampaignTemplate();
