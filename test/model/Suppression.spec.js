...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.Suppression();
  });
  ...
  describe('Suppression', function() {
    it('should create an instance of Suppression', function() {
      ...
      //var instane = new ElasticEmail.Suppression();
      //expect(instance).to.be.a(ElasticEmail.Suppression);
    });

    it('should have the property email (base name: "Email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new ElasticEmail.Suppression();
