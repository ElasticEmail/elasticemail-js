...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.SmtpCredentials();
  });
  ...
  describe('SmtpCredentials', function() {
    it('should create an instance of SmtpCredentials', function() {
      // uncomment below and update the code to test SmtpCredentials
      //var instane = new ElasticEmail.SmtpCredentials();
      //expect(instance).to.be.a(ElasticEmail.SmtpCredentials);
    });
    ...
    it('should have the property accessLevel (base name: "AccessLevel")', function() {
      ...
      //var instance = new ElasticEmail.SmtpCredentials();
