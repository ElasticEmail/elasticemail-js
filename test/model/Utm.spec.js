...
(function(root, factory) {
  ...
  describe('Utm', function() {
    it('should create an instance of Utm', function() {
      // uncomment below and update the code to test Utm
      //var instane = new ElasticEmail.Utm();
      //expect(instance).to.be.a(ElasticEmail.Utm);
    });

    it('should have the property source (base name: "Source")', function() {
      // uncomment below and update the code to test the property source
      //var instance = new ElasticEmail.Utm();
