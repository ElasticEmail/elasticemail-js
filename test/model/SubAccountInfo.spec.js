...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.SubAccountInfo();
  });
  ...
  describe('SubAccountInfo', function() {
    it('should create an instance of SubAccountInfo', function() {
      // uncomment below and update the code to test SubAccountInfo
      //var instane = new ElasticEmail.SubAccountInfo();
      //expect(instance).to.be.a(ElasticEmail.SubAccountInfo);
    });
    ...
    it('should have the property publicAccountID (base name: "PublicAccountID")', function() {
      ...
      //var instance = new ElasticEmail.SubAccountInfo();
