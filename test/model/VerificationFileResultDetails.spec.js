...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.VerificationFileResultDetails();
  });
  ...
  describe('VerificationFileResultDetails', function() {
    it('should create an instance of VerificationFileResultDetails', function() {
      // uncomment below and update the code to test VerificationFileResultDetails
      //var instane = new ElasticEmail.VerificationFileResultDetails();
      //expect(instance).to.be.a(ElasticEmail.VerificationFileResultDetails);
    });
    ...
    it('should have the property verificationResult (base name: "VerificationResult")', function() {
      ...
      //var instance = new ElasticEmail.VerificationFileResultDetails();
