...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.Options();
  });
  ...
  describe('Options', function() {
    it('should create an instance of Options', function() {
      ...
      //var instane = new ElasticEmail.Options();
      //expect(instance).to.be.a(ElasticEmail.Options);
    });
    ...
    it('should have the property timeOffset (base name: "TimeOffset")', function() {
      ...
      //var instance = new ElasticEmail.Options();
