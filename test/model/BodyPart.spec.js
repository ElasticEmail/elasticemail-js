...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.BodyPart();
  });
  ...
  describe('BodyPart', function() {
    it('should create an instance of BodyPart', function() {
      ...
      //var instane = new ElasticEmail.BodyPart();
      //expect(instance).to.be.a(ElasticEmail.BodyPart);
    });
    ...
    it('should have the property contentType (base name: "ContentType")', function() {
      ...
      //var instance = new ElasticEmail.BodyPart();
