...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.ApiKeyPayload();
  });
  ...
  describe('ApiKeyPayload', function() {
    it('should create an instance of ApiKeyPayload', function() {
      // uncomment below and update the code to test ApiKeyPayload
      //var instane = new ElasticEmail.ApiKeyPayload();
      //expect(instance).to.be.a(ElasticEmail.ApiKeyPayload);
    });

    it('should have the property name (base name: "Name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new ElasticEmail.ApiKeyPayload();
