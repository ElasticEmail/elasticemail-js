...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.NewSmtpCredentials();
  });
  ...
  describe('NewSmtpCredentials', function() {
    it('should create an instance of NewSmtpCredentials', function() {
      // uncomment below and update the code to test NewSmtpCredentials
      //var instane = new ElasticEmail.NewSmtpCredentials();
      //expect(instance).to.be.a(ElasticEmail.NewSmtpCredentials);
    });

    it('should have the property token (base name: "Token")', function() {
      // uncomment below and update the code to test the property token
      //var instance = new ElasticEmail.NewSmtpCredentials();
