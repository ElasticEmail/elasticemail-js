...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.ConsentData();
  });
  ...
  describe('ConsentData', function() {
    it('should create an instance of ConsentData', function() {
      // uncomment below and update the code to test ConsentData
      //var instane = new ElasticEmail.ConsentData();
      //expect(instance).to.be.a(ElasticEmail.ConsentData);
    });
    ...
    it('should have the property consentIP (base name: "ConsentIP")', function() {
      ...
      //var instance = new ElasticEmail.ConsentData();
