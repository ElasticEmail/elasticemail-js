...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.ListUpdatePayload();
  });
  ...
  describe('ListUpdatePayload', function() {
    it('should create an instance of ListUpdatePayload', function() {
      ...
      //var instane = new ElasticEmail.ListUpdatePayload();
      //expect(instance).to.be.a(ElasticEmail.ListUpdatePayload);
    });
    ...
    it('should have the property newListName (base name: "NewListName")', function() {
      ...
      //var instance = new ElasticEmail.ListUpdatePayload();
