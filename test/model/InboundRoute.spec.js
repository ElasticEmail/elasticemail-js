...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.InboundRoute();
  });
  ...
  describe('InboundRoute', function() {
    it('should create an instance of InboundRoute', function() {
      // uncomment below and update the code to test InboundRoute
      //var instane = new ElasticEmail.InboundRoute();
      //expect(instance).to.be.a(ElasticEmail.InboundRoute);
    });
    ...
    it('should have the property publicId (base name: "PublicId")', function() {
      ...
      //var instance = new ElasticEmail.InboundRoute();
    ...
    it('should have the property actionParameter (base name: "ActionParameter")', function() {
      // uncomment below and update the code to test the property actionParameter
      //var instance = new ElasticEmail.InboundRoute();
      //expect(instance).to.be();
    });
