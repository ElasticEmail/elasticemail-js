...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticEmail.SmtpCredentialsPayload();
  });
  ...
  describe('SmtpCredentialsPayload', function() {
    it('should create an instance of SmtpCredentialsPayload', function() {
      // uncomment below and update the code to test SmtpCredentialsPayload
      //var instane = new ElasticEmail.SmtpCredentialsPayload();
      //expect(instance).to.be.a(ElasticEmail.SmtpCredentialsPayload);
    });

    it('should have the property name (base name: "Name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new ElasticEmail.SmtpCredentialsPayload();
