...
* `LandingPageNewsletterProductTemplate` (value: `"LandingPageNewsletterProductTemplate"`)

* `LandingPageNewsletterPaymentConfirmationTemplate` (value: `"LandingPageNewsletterPaymentConfirmationTemplate"`)

* `NewsletterSubscriptionCancellationTemplate` (value: `"NewsletterSubscriptionCancellationTemplate"`)
