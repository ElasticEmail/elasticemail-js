...
* @readonly
*/
export default class MessageCategoryEnum {
    ...
    /**
    * Returns a <code>MessageCategoryEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MessageCategoryEnum} The enum <code>MessageCategoryEnum</code> value.
    */
