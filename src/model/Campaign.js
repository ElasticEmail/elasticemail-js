...
class Campaign {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ExcludedRecipients')) {
                obj['ExcludedRecipients'] = CampaignRecipient.constructFromObject(data['ExcludedRecipients']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['ExcludedRecipients']) { // data not null
          CampaignRecipient.validateJSON(data['ExcludedRecipients']);
        }
...
/**
 * @member {module:model/CampaignRecipient} ExcludedRecipients
 */
Campaign.prototype['ExcludedRecipients'] = undefined;
